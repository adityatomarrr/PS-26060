            ...
            <div className="flex items-center justify-between pb-3 border-b border-cyan-500/20">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-400 font-mono">Antarctic Digital Twin Access</p>
                </div>
              </div>
              <button
                onClick={() => {
      ...
      <div className="overview-command-header border border-cyan-500/25 bg-[#050b15] px-4 py-3 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-mono tracking-[0.22em] text-emerald-300 uppercase">Remote Operations Command Center</span>
          </div>
          <h2 className="text-xl md:text-2xl font-semibold tracking-tight text-slate-100 mt-1">ANTARCTIC DIGITAL TWIN</h2>
        </div>
